pipeline {
  ...
  parameters {
    string(name: 'GIT_COMMIT', defaultValue: '', description: '<p>Commit SHA or release tag to deploy<p><h1>Do NOT release the master branch to production. ONLY promote release tags to production</h1>')
  }
