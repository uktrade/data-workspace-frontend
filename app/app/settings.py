...
LOGIN_REDIRECT_URL = '/'
APPSTREAM_AWS_SECRET_KEY = env['APPSTREAM_AWS_SECRET_KEY']
APPSTREAM_AWS_ACCESS_KEY = env['APPSTREAM_AWS_ACCESS_KEY']
APPSTREAM_AWS_REGION = env['APPSTREAM_AWS_REGION']
APPSTREAM_STACK_NAME = env['APPSTREAM_STACK_NAME']
APPSTREAM_FLEET_NAME = env['APPSTREAM_FLEET_NAME']
