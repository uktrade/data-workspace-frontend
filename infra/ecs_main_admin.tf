locals {
  admin_container_vars = {
    ...
    fargate_spawner__sparkcluster_task_definition_arn  = "${aws_ecs_task_definition.sparkcluster.family}"
...
data "aws_iam_policy_document" "admin_run_tasks" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:ecs:${data.aws_region.aws_region.name}:${data.aws_caller_identity.aws_caller_identity.account_id}:task-definition/${aws_ecs_task_definition.superset.family}-*",
      "arn:aws:ecs:${data.aws_region.aws_region.name}:${data.aws_caller_identity.aws_caller_identity.account_id}:task-definition/${aws_ecs_task_definition.sparkcluster.family}-*",
      "arn:aws:ecs:${data.aws_region.aws_region.name}:${data.aws_caller_identity.aws_caller_identity.account_id}:task-definition/${aws_ecs_task_definition.sparkcluster.family}-*",
