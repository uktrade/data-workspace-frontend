locals {
  admin_container_vars = {
    ...
    fargate_spawner__dataflowide_task_definition_arn  = "${aws_ecs_task_definition.data_flow_ide.family}"
...
data "aws_iam_policy_document" "admin_run_tasks" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:ecs:${data.aws_region.aws_region.name}:${data.aws_caller_identity.aws_caller_identity.account_id}:task-definition/${aws_ecs_task_definition.theia.family}-*",
      "arn:aws:ecs:${data.aws_region.aws_region.name}:${data.aws_caller_identity.aws_caller_identity.account_id}:task-definition/${aws_ecs_task_definition.data_flow_ide.family}",
      "arn:aws:ecs:${data.aws_region.aws_region.name}:${data.aws_caller_identity.aws_caller_identity.account_id}:task-definition/${aws_ecs_task_definition.data_flow_ide.family}-*",
