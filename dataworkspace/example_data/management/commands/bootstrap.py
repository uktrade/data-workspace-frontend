...
from ._datasets import create_example_datasets, create_opendata_datasets
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.write_success("Create example datasets")
        create_example_datasets(iam, iao, self.stdout)

        self.write_success("Create open datasets")
        create_opendata_datasets(iam, iao, self.stdout)
