...
const tinymce_default_config: TinyMceOptions = {
  ...
  license_key: "gpl",
  plugins: "advlist autolink lists link searchreplace visualblocks code codesample fullscreen insertdatetime media table code wordcount",
  toolbar:
...
const initTinymce = (selector: string, config: TinyMceOptions = tinymce_default_config) => {
  tinymce.init({
