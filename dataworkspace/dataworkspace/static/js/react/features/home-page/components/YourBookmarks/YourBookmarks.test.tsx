...
describe('YourBookmarks', () => {
    describe('With bookmarks', () => {
        it('should render a title', () => {
            ...
            expect(getByRole('heading', { level: 3, name: 'Your bookmarks' }));
        });
    ...
    describe('No bookmarks', () => {
        ...
        it('should NOT render a list of links', () => {
            ...
            expect(queryByRole('link', { name: 'Bookmark 1' })).not.toBeInTheDocument();
            expect(queryByRole('link', { name: 'Bookmark 2' })).not.toBeInTheDocument();
        });
    });
});
