...
import { TransformedRecentCollectionResponse } from '../../../../types';
import RecentCollections from '.';

describe('RecentCollections', () => {
  const collections: TransformedRecentCollectionResponse = [
    {
  ...
  describe('Results returned', () => {
    it('should render a title', () => {
      ...
      expect(
        getByRole('heading', { level: 3, name: 'Your recent collections' })
      );
    });
    ...
    it('should NOT render a no collections message', () => {
      ...
      expect(
        queryByText(
          /You've currently not created a collection, or you're not apart of an existing collection./i
        )
