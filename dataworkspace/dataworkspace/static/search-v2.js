...
function accessibleAutocompleteOptions(data, dataSearchURL, GTM, liveSearchForm) {
  ...
  function resultTemplate(result) {
    console.log('this does it too 2')
