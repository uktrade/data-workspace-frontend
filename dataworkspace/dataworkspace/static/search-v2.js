  ...
  this.$form.on(
    ...
    function (e) {
      if (e.keyCode == 13) {
        ...
        var searchMenu = document.getElementById(
          "app-site-search__input__listbox"
        );
...
LiveSearch.prototype.redirect = function redirect() {
  window.location.href = this.$form.attr("action") + "?" + $.param(this.state);
};
...
function accessibleAutocompleteOptions(
  data,
  dataSearchURL,
  GTM,
  liveSearchForm
