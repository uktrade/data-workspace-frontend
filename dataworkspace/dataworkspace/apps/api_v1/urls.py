...
urlpatterns = [
    ...
    path('table/<str:table_id>/schema/', csrf_exempt(table_api_schema_view), name='table-scheme'),
    path('table/<str:table_id>/rows/', csrf_exempt(table_api_rows_view), name='table-rows'),
]
