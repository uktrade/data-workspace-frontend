# Generated by Django 4.2.15 on 2024-12-11 15:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("eventlog", "0046_alter_eventlog_event_type"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[
                    ...
                    (51, "Dataset bookmarked"),
                    (52, "Dataset bookmark removed"),
                    (53, "Tool failed to start for user"),
                    (54, "Datacut grid failed to load for user"),
                    (55, "Dataset nofitication sent to user"),
                    (56, "Stata access request"),
                    (57, "Added table to source dataset"),
                    (58, "Dataset description has changed"),
                ]
            ),
        ),
    ]
