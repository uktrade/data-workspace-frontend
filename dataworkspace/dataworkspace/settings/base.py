...
NOTIFY_DATASET_ACCESS_REQUEST_TEMPLATE_ID= "cf3b6d1c-22da-451b-988d-88d336b81c37"
NOTIFY_DATASET_ACCESS_GRANTED_TEMPLATE_ID= "b4913195-3695-4972-8f21-0853610be0b4"
NOTIFY_DATASET_ACCESS_DENIED_TEMPLATE_ID= "320947ff-0da4-44b2-bf41-1fafd77e1905"
NOTIFY_DATASET_ACCESS_REMOVE_TEMPLATE_ID= "72415397-728d-4dd7-825a-8d2446921205"
NOTIFY_DATASET_NOTIFICATIONS_USER_ACCESS_TEMPLATE_ID= "e666589f-c01a-4327-ba11-293988ab1eb6"


LEGACY_NOTIFY_DATASET_ACCESS_REQUEST_TEMPLATE_ID= "d213376f-22bb-46ff-b022-dae099ed2c38"
...
NOTIFY_UNPUBLISH_DATASET_CATALOUGE_PAGE_TEMPLATE_ID= "ae904fc7-b68d-4ce0-8acd-366170a07db0"
...
GITLAB_FIXTURES= env.get("GITLAB_FIXTURES")
...
STATICFILES_DIRS += [
    ...
    os.path.join(BASE_DIR, "static", "js", "bundles"),
]
...
>> >>>> > 2ea321d17(creating waffle flag and changing urls)
...
DATAFLOW_API_CONFIG= {
    ...
    "DATAFLOW_BASE_URL_DATA_WORKSPACE_AWS_INTERNAL": env.get(
        "DATAFLOW_BASE_URL_DATA_WORKSPACE_AWS_INTERNAL"
    ),
    "DATAFLOW_BASE_URL_DATA_WORKSPACE_AWS_USER_FACING": env.get(
        "DATAFLOW_BASE_URL_DATA_WORKSPACE_AWS_USER_FACING"
    ),
