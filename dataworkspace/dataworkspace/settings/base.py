...
HELP_DESK_EMAIL = env.get("HELP_DESK_INTERFACE", "")
HELP_DESK_SERVICE_FIELD_ID = env.get("HELP_DESK_SERVICE_FIELD_ID", "")
HELP_DESK_SERVICE_FIELD_VALUE = env.get("HELP_DESK_SERVICE_FIELD_VALUE", "")

# helpdesk abstraction
HELP_DESK_INTERFACE = env.get("HELP_DESK_INTERFACE", "")
HELP_DESK_CREDS = env.get("HELP_DESK_CREDS", "")
