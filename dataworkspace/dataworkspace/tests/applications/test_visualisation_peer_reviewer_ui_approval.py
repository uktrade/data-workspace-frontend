...
def _visualisation_ui_gitlab_mocks(
    ...
    with mock.patch(
        ...
        yield projects_mock, branches_mock, access_mock, user_mock, approver_type
...
class TestDataVisualisationPeerReviewerUIApprovalPage:
    ...
    def test_second_peer_reviewer_view_with_all_approvals(self):
        ...
        assert (
            ...
            .get_text()
            .startswith(
                "Gene Belcher (peer reviewer) approved this visualisation on 01 January 2025, 01:01am"
            )
        )
        assert (
