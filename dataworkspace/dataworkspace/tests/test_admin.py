    ...
    def test_manage_master_dataset_permission_allows_editing_unpublished_datasets(self, user):
        ...
        response = client.post(
            reverse("admin:datasets_masterdataset_change", args=(dataset.id,)),
            {
                ...
                "sourcetable_set-MAX_NUM_FORMS": "1000",
                "_continue": "Save and continue editing",
                "arangodocumentcollection_set-TOTAL_FORMS": "0",
                "arangodocumentcollection_set-INITIAL_FORMS": "0",
                "arangodocumentcollection_set-MIN_NUM_FORMS": "0",
                "arangodocumentcollection_set-MAX_NUM_FORMS": "1000",
                "charts-TOTAL_FORMS": "1",
                "charts-INITIAL_FORMS": "0",
                "charts-MIN_NUM_FORMS": "0",
                "charts-MAX_NUM_FORMS": "1000",
