...
- example dataset tags
- example master datasets.

```(bash)
$ make load-example-data
```

This depends on tables generated by [data-flow](https://github.com/uktrade/data-flow/tree/master/dataflow/dags/example_data) example DAGS.
